    ...
    <div style="width: 1100px">
      ...
      >
        <el-form :model="form" :rules="rules"  ref="form">
          ...
          <el-form-item>
            <el-col :span="12">
              <el-form-item label="成果" :label-width="formLabelWidth">
                <el-input
                  v-model="form.result"
                  autocomplete="off"
                ></el-input>
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        ...
        this.$axios
          .post('/social_prc/list/getInfoTable', {
          ...
          .then((result) => {
            ...
            if (result.data.code === 1) {
              ...
              this.tableData = result.data.datas.social_prcs;
            } else {
      ...
      editOk() {
        this.$axios
          .post('/social_prc/update', this.form)
          .then((result) => {
            if (result.data.code === 1) {
              //返回第一页数据，和
              this.$message({
